...
begin
    select term, interest_rate into v_term, v_interest_rate from cb_deposit_products where product_name = 'Novruz Emaneti';
...
select * from cb__customer_deposits;
