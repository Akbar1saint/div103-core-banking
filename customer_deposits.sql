create table cb__customer_deposits(
...
p_customer_id number, p_deposit_product_id number, p_contract_no varchar2, p_deposit_amount number, p_profit_amount number, p_start_date date)
is begin
    insert into cb__customer_deposits (customer_id, deposit_product_id, contract_no, deposit_amount, profit_amount, start_date)
...
p_id number, p_customer_id number default null, p_deposit_product_id number default null, p_contract_no varchar2 default null, p_deposit_amount number default null, p_profit_amount number default null, p_start_date date default null)
is begin
    update cb__customer_deposits set 
